...
function PatternOverridesToolbarIndicator({
  ...
  const blockDescription = isSingleBlockSelected ? sprintf(/* translators: 1: The block type's name. 2: The block's user-provided name (the same as the override name). */
