...
const transforms = {
  ...
  to: [{
    ...
    transform: ({
      citation
    }, innerBlocks) => RichText.isEmpty(citation) ? innerBlocks : [...innerBlocks, createBlock('core/paragraph', {
      content: citation
    })]
  }, {
    type: 'block',
    ...
    transform: ({
      ...
      anchor
    }, RichText.isEmpty(citation) ? innerBlocks : [...innerBlocks, createBlock('core/paragraph', {
      content: citation
    })])
  }],
  ungroup: ({
