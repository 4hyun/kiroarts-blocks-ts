...
export default function SearchEdit({
  ...
  const controls = /*#__PURE__*/_jsxs(_Fragment, {
    children: [/*#__PURE__*/_jsx(BlockControls, {
      children: /*#__PURE__*/_jsxs(ToolbarGroup, {
        ...
        }), /*#__PURE__*/_jsx(ToolbarDropdownMenu, {
          icon: getButtonPositionIcon(),
          label: __('Change button position'),
          controls: buttonPositionControls
        }), !hasNoButton && /*#__PURE__*/_jsx(ToolbarButton, {
  ...
  const labelClassnames = clsx('wp-block-search__label', typographyProps.className);
  return /*#__PURE__*/_jsxs("div", {
    ...blockProps,
    children: [controls, showLabel && /*#__PURE__*/_jsx(RichText, {
      identifier: "label",
