...
import { InnerBlocks, useInnerBlocksProps, useBlockProps, privateApis as blockEditorPrivateApis } from '@wordpress/block-editor';
...
const migrateColors = (attributes, innerBlocks) => {
  ...
  if (hasSingleInnerGroupBlock(innerBlocks)) {
    ...
    const updatedGroupBlock = createBlock('core/group', {
...
const migrateDisplayLayout = (attributes, innerBlocks) => {
  ...
  const newPostTemplateBlock = createBlock('core/post-template', {
