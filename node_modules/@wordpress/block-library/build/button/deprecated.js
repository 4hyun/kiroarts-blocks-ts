...
function migrateAlign(attributes) {
  ...
  return {
    ...otherAttributes,
    className: (0, _clsx.default)(otherAttributes.className, `align${attributes.align}`)
  };
}
...
const v12 = {
  ...
  save({
    ...
    const buttonClasses = (0, _clsx.default)('wp-block-button__link', colorProps.className, borderProps.className, {
...
const deprecated = [v12, v11, v10, {
  ...
  save({
    ...
    const colorProps = (0, _blockEditor.__experimentalGetColorClassesAndStyles)(attributes);
    const buttonClasses = (0, _clsx.default)('wp-block-button__link', colorProps.className, {
      'no-border-radius': style?.border?.radius === 0
    });
    const buttonStyle = {
  ...
  save({
    ...
    const buttonClasses = (0, _clsx.default)('wp-block-button__link', {
      'no-border-radius': borderRadius === 0
    });
    const buttonStyle = {
      borderRadius: borderRadius ? borderRadius + 'px' : undefined
