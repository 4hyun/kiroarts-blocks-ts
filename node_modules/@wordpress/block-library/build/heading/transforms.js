...
var _getTransformedMetadata = require("../utils/get-transformed-metadata");
/**
...
const transforms = {
  from: [{
    ...
    transform: attributes => attributes.map(({
      ...
      anchor,
      textAlign,
      metadata: (0, _getTransformedMetadata.getTransformedMetadata)(metadata, 'core/heading', ({
  ...
  to: [{
    ...
    transform: attributes => attributes.map(({
      ...
      content,
      align,
      metadata: (0, _getTransformedMetadata.getTransformedMetadata)(metadata, 'core/paragraph', ({
        content: contentBinding
      }) => ({
        content: contentBinding
      }))
